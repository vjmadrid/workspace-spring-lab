...
import com.acme.example.spring.testing.initializer.ConfigTestInitializer;

@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(initializers = { ConfigTestInitializer.class })
public class InitializerConfigApplicationContextTest {
